...
def stack_push_callback(ctx: mp.MethodContext) -> mt.Type:
    ...
    candidates: ty.Dict[str, str] = {
        'pyksp.service_types.LocInt': 'pyksp.base_types.VarInt',
        'pyksp.service_types.LocStr': 'pyksp.base_types.VarStr',
        'pyksp.service_types.LocFloat': 'pyksp.base_types.VarFloat',
        'pyksp.service_types.LocArrInt': 'pyksp.base_types.ArrInt',
        'pyksp.service_types.LocArrStr': 'pyksp.base_types.ArrStr',
        'pyksp.service_types.LocArrFloat': 'pyksp.base_types.ArrFloat',
        'builtins.int': 'pyksp.base_types.VarInt',
        'builtins.str': 'pyksp.base_types.VarStr',
        'builtins.float': 'pyksp.base_types.VarFloat',
    }
...
class KspPlugin(mp.Plugin):
    ...
    def get_method_hook(
        self, fullname: str
    ) -> ty.Optional[ty.Callable[[mp.MethodContext], mp.Type]]:
