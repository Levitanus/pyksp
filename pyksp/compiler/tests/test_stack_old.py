...
class TestFrameVar(DevTest):
    ...
    def test_kArrInt_code(self):
        ...
        seq = [arr[2:4]]
        var_arr = FrameVarCompile('arr', seq)
...
class TestStackFrame(DevTest):
    ...
    def runTest(self):
        x = FrameVarCompile('x', 1)
        y = FrameVarCompile('y', 3)
        arr = FrameVarCompile('arr', [1, 2, 4, 5])
